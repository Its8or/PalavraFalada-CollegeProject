...
export default function QrCodeDaTurma() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal visible={telaCheia} animationType="fade" onRequestClose={fecharTelaCheia}>
        <View style={styles.telaCheiaContainer}>
          <TouchableOpacity style={styles.telaCheiaFechar} onPress={fecharTelaCheia}>
...
const styles = StyleSheet.create({
  ...
  conteudo: { flex: 1, alignItems: 'center', padding: 24, gap: 16 },
  nomeTurma: { fontSize: 16, color: '#5C6B73', marginTop: 10 },
